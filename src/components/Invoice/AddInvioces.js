...
<div className="page-titles">
    <ol className="breadcrumb">
        ...
        <li><h5 className="bc-title">Invoice # 1001</h5></li>
    </ol>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            <div className="c-details">
                                <ul>
                                    <li className="d-flex">
                                        <span><b>Email:</b>  email@gmail.com</span>
                                     
                                    </li>
                                    <li className="d-flex">
                                        <span><b>Phone:</b>  +92-000-999-8888</span>
                    ...
                    <div className="custom-tab-1">
                        <ul className="nav nav-tabs" role="tablist">
                            <li className="nav-item" role="presentation">
                                <a className="nav-link active" data-bs-toggle="tab" href="#home1" aria-selected="true" role="tab"><i className="la la-file-invoice me-2"></i> Invoice</a>
                            </li>
                            <li className="nav-item" role="presentation">
                                <a className="nav-link" data-bs-toggle="tab" href="#profile1" aria-selected="false" tabindex="-1" role="tab"><i className="la la-paypal me-2"></i> Payment</a>
                            </li>

                        </ul>
                        <div className="tab-content">
                            <div className="row tab-pane fade show active" id="home1" role="tabpanel">
                                <div className="col-md-12 mb-2 mt-2">
                                    <button type="button" className="btn btn-sm btn-primary light me-1"><i className="fa fa-print me-2"></i>Print</button>
                                    <button type="button" className="btn btn-sm btn-primary light me-1"><i className="fa fa-envelope me-2"></i>Email</button>
                                    <button type="button" className="btn btn-sm btn-primary light me-1"><i className="fa fa-download me-2"></i>Download</button>
                                </div>
                                <div className="col-md-12">
                                    <div className="row">
                                        <div className="mb-3 col-md-3">
                                            ...
                                            <div className="input-group mb-2">
                                                ...
                                                <input type="text" className="form-control" placeholder="Leave blank to auto complete"/>
                                            </div>
                                                ...
                                                <table id="empoloyees-tblwrapper" className="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><span className="text-primary">20</span></td>
                                                            <td>
                                                                <span>20</span>
                                                            </td>
        ...
        <div className="modal-dialog" role="document">
            <div className="modal-content">
                ...
                <div className="modal-footer">
                    <button type="button" className="btn btn-danger btn-md light" data-bs-dismiss="modal">Close</button>

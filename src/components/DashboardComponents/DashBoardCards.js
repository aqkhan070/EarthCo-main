    ...
    <div className="col-xl-12 wid-100">
            <div className="row">
              <div className="col-xl-3  col-lg-6 col-sm-6">
                <div className="widget-stat card">
                  <div className="card-body p-4">
                    ...
                    <h3 style={{ fontWeight: "600" }}>{dashBoardData.OpenServiceRequestCount}</h3>
              ...
              <div className="col-xl-3  col-lg-6 col-sm-6">
                <div className="widget-stat card">
                  <div className="card-body p-4">
                    <h6>Open Estimates</h6>
                    <h3 style={{ fontWeight: "600" }}>{dashBoardData.OpenEstimateCount}</h3>
                    
                    <div className="progress mb-2">
                      <div
                        className="progress-bar progress-animated bg-danger"
                        style={{ width: "50%" }}
                      ></div>
                    </div>
                    {/* <small>50% Increase in 25 Days</small> */}
              ...
              <div className="col-xl-3  col-lg-6 col-sm-6">
                <div className="widget-stat card">
                  <div className="card-body p-4">
                    <h6>Approved Estimates</h6>
                    <h3 style={{ fontWeight: "600" }}>{dashBoardData.ApprovedEstimateCount}</h3>
                  ...
                  <div className="card-body depostit-card">
                    <div className="depostit-card-media d-flex justify-content-between style-1">
                      <div>
                        ...
                        <h3>{dashBoardData.BilledInvoiceCount}</h3>
                      </div>
              ...
              <div className="col-xl-3  col-lg-6 col-sm-6">
                <div className="widget-stat card">
                  <div className="card-body p-4">
                    <h6>Closed Bill</h6>
                    <h3 style={{ fontWeight: "600" }}>{dashBoardData.ClosedBillCount}</h3>
                    <div className="progress mb-2">
                      <div
                        className="progress-bar progress-animated bg-success"
                        style={{ width: "100%" }}
              ...
              <div className="col-xl-3  col-lg-6 col-sm-6">
                <div className="widget-stat card">
                  <div className="card-body p-4">
                    ...
                    <h3 style={{ fontWeight: "600" }}>{dashBoardData.OpenPunchlistCount}</h3>
                    <div className="progress mb-2">
                      <div
                        className="progress-bar progress-animated bg-danger"
                        style={{ width: "30%" }}
              ...
              <div className="col-xl-3  col-lg-6 col-sm-6">
                <div className="widget-stat card">
                  <div className="card-body p-4">
                    ...
                    <h3 style={{ fontWeight: "600" }}>{dashBoardData.OpenLandscapeCount}</h3>
                    <div className="progress mb-2">
                      <div

            ...
            <div className="card-body p-4">
              <div className="row">
                <div className="col-md-6">
                  <h6 className="table-cell-align">Open Estimates</h6>
                  <h3 style={{ fontWeight: "600" }}>
        ...
        <div className="col-xl-3  col-lg-6 col-sm-6">
          <div className="widget-stat card">
            <div className="card-body p-4">
              <div className="row">
                <div className="col-md-6">
                  <h6 className="table-cell-align">Approved Estimates</h6>
                  <h3 style={{ fontWeight: "600" }}>
        ...
        <div className="col-xl-3  col-lg-6 col-sm-6">
          <div className="widget-stat card">
            <div className="card-body p-4">
              <div className="row">
                <div className="col-md-6">
                  <h6 className="table-cell-align">Closed Bill</h6>
                  <h3 style={{ fontWeight: "600" }}>
        ...
        <div className="col-xl-3  col-lg-6 col-sm-6">
          <div className="widget-stat card">
            <div className="card-body p-4">
              ...
              <h3 style={{ fontWeight: "600" }}>
                {dashBoardData.OpenLandscapeCount}
              </h3>
              <div className="progress mb-2">
                <div
